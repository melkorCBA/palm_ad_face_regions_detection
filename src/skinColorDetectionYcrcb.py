...
def main():
    ...
    while cap.isOpened():
        ...
        #draw contours
        cv2.drawContours(displayFrame, contours, -1, (255, 0, 0), 3)
        ...
        #     cv2.imwrite('assets/outputFrames/ycrcb_binary_frame101.jpg', binaryImage)
        #     cv2.imwrite('assets/outputFrames/ycrcb_densty_frame101.jpg',  noiseRemovedImage)
        #     cv2.imwrite('assets/outputFrames/ycrcb_noise_frame101.jpg', opening)
        #     cv2.imwrite('assets/outputFrames/ycrcb_finalContours.jpg', displayFrame)
